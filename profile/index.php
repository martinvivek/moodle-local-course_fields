...
require_once($CFG->dirroot.'/local/course_fields/profile/definelib.php');

admin_externalpage_setup('local_course_fields');

$action   = optional_param('action', '', PARAM_ALPHA);

$redirect = $CFG->wwwroot.'/local/course_fields/profile/index.php';
...
$popupurl = new moodle_url('/local/course_fields/profile/index.php?id=0&action=editfield');
